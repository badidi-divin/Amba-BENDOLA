<?php
	...
	require_once('../model/ajout-tache.php');
	$id=1;
?>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h2 align="center">AJOUT TACHE</h2>
		</div>
		<div class="panel-body">
			<form method="post" action="">
				...
				<div class="form-group">
				    ...
				    <input type="text" class="form-control" placeholder="designation" name="designation" value="<?php if(isset($designation)){ echo $designation; } ?>">
				</div>
				<div class="form-group">
					<label class="control-label">Description:</label>
				     <textarea type="text" class="form-control" placeholder="Description" name="description" value="<?php if(isset($description)){ echo $description; } ?>"> </textarea>
				 </div>
