<?php
	...
	$id=$_GET['id'];
	$requser=$pdo->prepare("SELECT * FROM contact2 WHERE id=?");
	...
	if (isset($_POST['saves'])) {
		...
		if (empty($errors)) {
		    ...
		    $ps=$pdo->prepare("UPDATE contact2 SET message=?,demande=? WHERE id=?");
			...
			<script>
				window.open('liste_rendez_vous.php','_self')
			</script>
			<?php
...
<!-- 	      <img src="../images/logos.png" width="90px" height="80Px" title="Heavens Entrepreneurs"> -->
	   ...
	   <div class="collapse navbar-collapse" id="ftco-nav">
	      <ul class="navbar-nav ml-auto">
	        <li class="nav-item"><a href="../Pages/contact2.php" class="nav-link"> <p>Accueil</p></a></li>
