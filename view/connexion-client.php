<?php
	require_once('../model/connexion-client.php');
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="contenair col-md-6 col-xd-12 col-md-offset-3">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h3 class="a">CONNEXION FRONT-OFFICE</h3>
		</div>
		<div class="panel-body">
			<form method="post" action="">
				<div class="form-group">
					...
					<input type="password" name="code" required="required" class="form-control">
				</div>
				<div class="control-label a">
					<button type="submit" class="btn btn-primary" name="connect-cli">Se connecter</button>
				</div>
