<?php
	...
	if (isset($_POST['saves'])) {
		...
		if (empty($errors)) {
		    ...
		    $ps=$pdo->prepare("UPDATE video SET titre=?,message=?,autorisation=? WHERE id=?");
		    //Pour bien recupere les données on crée un table de parametre
		    $params=array($titre,$message,$autorisation,$id);
		    //Execution de la requête par leur paramètre en ordre 
		    $ps->execute($params);
			// Pour recuperer l'id du user
			?>
			<script type="text/javascript">
				alert('Temoignage modifié avec Succès!')
			</script>
			<script>
				window.open('liste_temoignage.php','_self')
			</script>
			<?php
...
<!-- 	      <img src="../images/logos.png" width="90px" height="80Px" title="Heavens Entrepreneurs"> -->
	   ...
	   <div class="collapse navbar-collapse" id="ftco-nav">
	      <ul class="navbar-nav ml-auto">
	        <li class="nav-item"><a href="../Pages/video.php" class="nav-link"> <p>Accueil</p></a></li>
	      ...
	      <div class="row">
		       ...
		       <div class="col-md-5 order-md-last">
		         <div class="login-wrap p-4 p-md-5">
		            ...
		            <h3 class="mb-4">Edition du Temoignage</h3>
		            <form action="" method="post" class="signup-form" enctype="multipart/form-data">
		               ...
		               <div class="form-group">
		                  ...
		                  <input type="text" name="titre" class="form-control" value="<?= $userinfo['titre']; ?>">
		                </div>
		                <div>
		                ...
		                <div class="form-group">
		                  <label class="label" for="name">Autorisation</label>
		                  <textarea type="number" name="autorisation" class="form-control"><?= $userinfo['autorisation']; ?></textarea>
		               </div>
