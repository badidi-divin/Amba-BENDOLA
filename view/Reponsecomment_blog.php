<?php
	...
	if (isset($_GET['id']) AND $_GET['id'] >  0) {
		...
		$requser2=$pdo->prepare("SELECT * FROM reponse WHERE id_parent=?");
				...
				<div class="panel panel-info spacer">
					...
					<div class="panel-body">
						<table class="table table-striped">
							<thead>
								<tr>
									<th>Auteur</th><th>REPONSE</th><th>DATES</th>								
								</tr>
							</thead>
							<tbody>
								...
								<!--liens -->
								<td>
									<a class="btn btn-danger" onclick="return confirm('Etes-vous sûre...?');" href="Supprimereponse_blog.php?id=<?php echo($et['id'])?>">Supprimer</a>
								</td>
											</tr>	
									<?php } ?>	
							</tbody>
