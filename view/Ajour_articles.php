<?php
	...
	if (isset($_POST['saves'])) {
		...
		if (empty($errors)) {
		    ...
		    $ps=$pdo->prepare("INSERT INTO blog(nom,description,image)VALUES(?,?,?)");
		    //Pour bien recupere les données on crée un table de parametre
		    $params=array($nom,$description,$fileName);
			...
			<script>
				window.open('Ajour_articles.php','_self')
			</script>
			<?php
...
<!-- 	      <img src="../images/logos.png" width="90px" height="80Px" title="Heavens Entrepreneurs"> -->
	   ...
	   <div class="collapse navbar-collapse" id="ftco-nav">
	      <ul class="navbar-nav ml-auto">
	        ...
	        <li class="nav-item"><a href="commentaires.php" class="nav-link"> <p>Edition</p></a></li>
		         ...
		         <div class="login-wrap p-4 p-md-5">
		            ...
		            <form action="" method="post" class="signup-form" enctype="multipart/form-data">
		               ...
		               <div class="form-group">
		                 ...
		                 <button type="submit" name="saves" class="btn btn-outline-primary">Créer<span class="fa fa-paper-plane"></span></button>
		             	</div>
		         </form>        
		     </div>
		 </div>
